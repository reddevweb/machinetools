...
<html lang="zxx">
    ...
    <head>
        ...
        <title>Motor Land / Car Rental</title>
...
<![endif]-->
    ...
    <body>
        ...
        <div class="l-theme animated-css" data-header="sticky" data-header-top="200" data-canvas="container">
                        ...
                        <div class="container">
                            <div class="header-navibox-1">
                                ...
                                <a class="navbar-brand scroll" href="home.html">
                                    ...
                                    <img class="scroll-logo img-responsive hidden-xs" src="assets/media/general/logo-dark.png" alt="logo" />
                                </a>
                            </div>
                            <div class="header-navibox-2">
                                ...
                                </ul><a class="btn btn-primary" href="home.html">reservation</a>
                            </div>
                        </div>
                    </nav>
                </div>
                        ...
                        <form class="b-booking-form area-bg area-bg_prim">
                            <div class="area-bg__inner">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input class="form-control" type="text" id="datepicker" placeholder="Pickup Date &amp; Time" required="required" />
                                    </div>
                                    <div class="col-md-3">
                                        <input class="form-control" type="text" id="offdatepicker" placeholder="Drop Off Date &amp; Time" required="required" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <select class="selectpicker" data-width="100%">
                                            <option>Number of Peoplect</option>
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                                        </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="radio-group">
                                            ...
                                            <label class="forms__label forms__label-radio forms__label-radio-1" for="forms__radio-1">One Way</label>
                                            <input class="forms__radio hidden" id="forms__radio-2" type="radio" name="radio-group-2" value="" checked="checked" />
                                            <label class="forms__label forms__label-radio forms__label-radio-1" for="forms__radio-2">Return Trip</label>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="section-type-2__img">
                                <img class="img-responsive" src="assets/media/content/other/1.jpg" alt="foto">
                            </div>
                        </div>
                        <div class="col-md-7">
            ...
            <!-- end .section-type-2-->
            <section class="section-rent area-bg parallax" style="background-image: url(assets/media/content/bg/bg-10.jpg)">
                <div class="area-bg__inner">
                    ...
                    <div class="rent-carousel">
                        <div class="owl-carousel owl-theme enable-owl-carousel" data-min768="2" data-min992="2" data-min1200="3" data-margin="30" data-pagination="false" data-navigation="true" data-auto-play="4000" data-stop-on-hover="true">
                            <div class="b-rent">
                                <img class="b-rent__img img-responsive" src="assets/media/components/b-rent/1.jpg" alt="img">
                                <div class="b-rent__title">Mini Cars</div>
                                <div class="b-rent__price">Starting from $50/ Day</div>
                                <div class="ui-decor-2"></div>
                                <ul class="b-rent__list list-unstyled">
                                    <li class="b-rent__list-item"><i class="icon flaticon-doors"></i>2 Doors</li>
                                    <li class="b-rent__list-item"><i class="icon flaticon-transport-1"></i>2 Passenger Seats</li>
                                    <li class="b-rent__list-item"><i class="icon flaticon-ac"></i>Chilled AC / Heater</li>
                                    <li class="b-rent__list-item"><i class="icon flaticon-suitcase-with-white-details"></i>1 Suitcase / 2 Handbags</li>
                                </ul>
                            </div>
                            <div class="b-rent">
                                <img class="b-rent__img img-responsive" src="assets/media/components/b-rent/2.jpg" alt="img">
                                <div class="b-rent__title">Luxury Cars</div>
                                <div class="b-rent__price">Starting from $80/ Day</div>
                                <div class="ui-decor-2"></div>
                                <ul class="b-rent__list list-unstyled">
                                    <li class="b-rent__list-item"><i class="icon flaticon-doors"></i>4 Doors</li>
                                    <li class="b-rent__list-item"><i class="icon flaticon-transport-1"></i>4 Passenger Seats</li>
                                    <li class="b-rent__list-item"><i class="icon flaticon-ac"></i>Chilled AC / Heater</li>
                                    <li class="b-rent__list-item"><i class="icon flaticon-suitcase-with-white-details"></i>2 Suitcase / 4 Handbags</li>
                                </ul>
                            </div>
                            <div class="b-rent">
                                <img class="b-rent__img img-responsive" src="assets/media/components/b-rent/3.jpg" alt="img">
                                <div class="b-rent__title">Mini Cars</div>
                                <div class="b-rent__price">Starting from $50/ Day</div>
                                <div class="ui-decor-2"></div>
                                <ul class="b-rent__list list-unstyled">
                                    <li class="b-rent__list-item"><i class="icon flaticon-doors"></i>6 Doors</li>
                                    <li class="b-rent__list-item"><i class="icon flaticon-transport-1"></i>12 Passenger Seats</li>
                                    <li class="b-rent__list-item"><i class="icon flaticon-ac"></i>Chilled AC / Heater</li>
                                    <li class="b-rent__list-item"><i class="icon flaticon-suitcase-with-white-details"></i>4 Suitcase / 6 Handbags</li>
                                </ul>
                            </div>
                            <div class="b-rent">
                                <img class="b-rent__img img-responsive" src="assets/media/components/b-rent/1.jpg" alt="img">
                            ...
                            <div class="carousel-reviews-2 owl-carousel owl-theme enable-owl-carousel" data-min768="1" data-min992="2" data-min1200="3" data-margin="30" data-pagination="true" data-navigation="false" data-auto-play="4000" data-stop-on-hover="true">
                                <div class="b-blockquote b-blockquote-3">
                                    ...
                                    <div class="b-blockquote__footer">
                                        ...
                                        <cite class="b-blockquote__cite"><span class="b-blockquote__author">Nick William</span><span class="b-blockquote__category">Car Rental Client</span></cite>
                                    </div>
                                </div>
                                <!-- end .b-blockquote-->
                                <div class="b-blockquote b-blockquote-3">
                                    ...
                                    <div class="b-blockquote__footer">
                                        <div class="b-blockquote__img">
                                            <img src="assets/media/components/b-blockquote/face-3.jpg" alt="foto" />
                                        </div>
                                        <cite class="b-blockquote__cite"><span class="b-blockquote__author">James Liam</span><span class="b-blockquote__category">Car Rental Client</span></cite>
                                    </div>
                                </div>
                                <!-- end .b-blockquote-->
                                <div class="b-blockquote b-blockquote-3">
